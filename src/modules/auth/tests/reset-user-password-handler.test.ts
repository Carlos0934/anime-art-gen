...
describe("ResetUserPasswordHandler", () => {
  ...
  test.concurrent(
    "should reset user password when provided valid token, old password, and new password",
    async () => {
      // Arrange
  ...
  test.concurrent(
    "should throw an error when provided with an invalid token",
    async () => {
      // Arrange
      const ctx = createTestContext();
  ...
  test.concurrent(
    "should throw an error when provided with an invalid old password",
    async () => {
      // Arrange
      const ctx = createTestContext();
      const user = UserMother.createDefaultUser();
